...
const initialRobots = [
    { id: 1, title: "ربات جوش و لیزر", subtitle: "ربات جوش و لیزر", src: "../../../src/assets/images/educate/educate1.jpg" },
    { id: 2, title: "ربات جوش و لیزر", subtitle: "ربات جوش و لیزر", src: "../../../src/assets/images/educate/educate2.jpg" },
    { id: 3, title: "ربات جوش و لیزر", subtitle: "ربات جوش و لیزر", src: "../../../src/assets/images/educate/educate3.jpg" },
    { id: 4, title: "ربات جوش و لیزر", subtitle: "ربات جوش و لیزر", src: "../../../src/assets/images/educate/educate4.jpg" },
];


function Educate({ videos }) {
    // state
    const MAX_LENGTH = 50;
    ...
    const totalPages = Math.ceil(videos["ربات و جوش لیزر"].length / ITEMS_PER_PAGE);

    const handlePageChange = (page) => {
        setCurrentPage(page);
    };

    const displayedvideos = videos["ربات و جوش لیزر"].slice(
